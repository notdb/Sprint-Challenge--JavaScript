...
console.log(notTyrannosaurusObject.weight);

// What was the diet of a velociraptor?
console.log(notVelociraptorObject.diet);

// How long was a stegosaurus?
console.log(notStegosaurusObject.length);

// What time period did tyrannosaurus live in?
console.log(notTyrannosaurusObject.period);


// Create a new roar method for the tyrannosaurus.  When called, return "RAWERSRARARWERSARARARRRR!" Log the result.
console.log(notTyrannosaurusObject.roar());
...
function somethingSomethingSomething(){
  for(let i=0; i<graduates.length; i++){
    ...
    notUni.push(graduates[i].university)
  }
